...
const testimonials = [
  ...
  {
    quote:
      "Working with Maxwell was a game-changer for our project. He delivered ahead of schedule with code quality that set a new standard for our team.",
  ...
  {
    quote:
      "Maxwell's expertise in React and TypeScript helped us rebuild our entire frontend in record time. His architectural decisions continue to pay dividends.",
    author: "Emily Watson",
          ...
          <div className="relative">
            ...
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200">
              ...
              <div className="flex items-center gap-4">
                <img
                  src={testimonials[activeIdx].avatar || null}
