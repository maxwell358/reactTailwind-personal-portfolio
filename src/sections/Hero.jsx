...
export const Hero = () => {
 ...
 <div className="space-y-4">
    ...
    <div className="flex flex-wrap gap-4 animated-fade-in animation-delay-300">
        <Button className="size lg"> Contact Me <ArrowRight className="w-5 h-5"/>
         </Button>
        <a href="/resume.docx" download="Maxwell_Godwill_CV.docx">
    ...
    <div className="flex items-center gap-4 animated-fade-in animation-delay-400">
        ...
        {[
            { icon: "GitHub", href: "https://github.com/maxwell358" },
            { icon: "LinkedIn", href: "#" },
            { icon: "Twitter", href: "#" },
        ].map((social, idx) => (
   ...
   <div className="relative animate-fade-in animation-delay-300">
     ...
     <div className="relative max-w-md mx-auto py-10">
         <div
              ...
              />
              {/* Floating Badge */}
              <div className="absolute -bottom-4 -right-4 glass rounded-xl px-7 py-3 animate-float">
                <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-green-50 rounded-full animate-pulse"/>
                    <span className="text-sm font-medium text-white ">Available for work</span>
                </div>
              </div>
              {/* Stats Badge */}
              <div className="aboslute -top-4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
                ...
                <div className="relative overflow-hidden">
                    <div className="flex animate-marquee">
                        {[...skills, ...skills].map((skills,idx) => (
                            <div key={idx} className="flex-shrink-0 px-8 py-4 hover:bg-muted">
                                <span  >{skills}</span>
                            </div>
